...
p.insured_comp_name,p.insured_org_code,p.recipients,p.recipients_tel,p.reci_address,p.premium,p.pay_status,p.reward_status,
p.car_type_code,p.ton_count,p.seat_num,p.is_paper_policy,p.is_paper_invoice,

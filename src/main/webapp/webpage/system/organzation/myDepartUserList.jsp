...
<div id="divUserList" class="easyui-layout" style="width:100%;">
	...
	<t:datagrid name="departUserList" title="common.operation"
		...
		<t:dgCol title="common.status" sortable="true" width="20" field="status" query="true" queryMode="group" replace="common.active_1,common.inactive_0,super.admin_-1"></t:dgCol>

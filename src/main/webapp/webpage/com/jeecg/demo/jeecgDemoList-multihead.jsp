...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgDemoList" checkbox="true" sortName="birthday,name" pagination="true" fitColumns="true" title="多表头列表 Demo" 
    ...
    <t:dgCol title="另一兰"  field="salary1" rowspan="2"  width="120"></t:dgCol>  
    <t:dgCol title="名称"  rowspan="2" field="name"  autocomplete="true"   width="120"></t:dgCol>
    <t:dgCol title="年龄"  rowspan="2" extend="{style:'width:50px'}"  style="background-color:#3a87ad_50,background-color:#f89406_100" editor="numberbox" field="age"  query="true" width="120"></t:dgCol>
    <t:dgCol title="性别" rowspan="2" field="sex"  query="true" showMode="radio" dictionary="sex" width="120"></t:dgCol>
    <t:dgCol title="电话" rowspan="2" field="phone" queryMode="group"  width="120"></t:dgCol>     

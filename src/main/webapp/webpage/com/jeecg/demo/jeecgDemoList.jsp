...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgDemoList" checkbox="true" sortName="birthday,name" pagination="true" fitColumns="false" title="jeecg_demo" 
    ...
    <t:dgCol title="性别"  field="sex"  frozenColumn="true" query="false" showMode="radio" checkbox="true"  dictionary="sex" width="120" extendParams="styler:fmtype"></t:dgCol>
    <t:dgCol title="电话"  field="phone" queryMode="group"  width="120"></t:dgCol>
    <t:dgCol title="工资"  field="salary" query="false" queryMode="group" width="120" checkbox="true"></t:dgCol>
	    	...
	    	$.dialog.confirm("确定要支付这[ "+rows.length+" ]张保单吗？", function(r) {
			   if (r) {
					...
					for ( var i = 0; i < rows.length; i++) {
						var rowMap = {};
						rowMap.id = rows[i].id;
						//rowMap.proposalNo = rows[i].proposalNo;
						rowMap.proposalNo = "proposalNo";
						//rowMap.orderNo = rows[i].orderNo;
						rowMap.orderNo = "orderNo";
						//rowMap.policyMobile = rows[i].policyMobile;
						rowMap.policyMobile = "policyMobile";
						params.push(rowMap);
					}
					$.ajax({
						url : url,

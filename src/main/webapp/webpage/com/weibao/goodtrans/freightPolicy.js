...
function getSubmitParam() {
	...
	param.holderPartType = document.getElementById("holderPartType").value;
	...
	param.insuredPartType = document.getElementById("insuredPartType").value;
	...
	param.cargoStartSite = document.getElementById("cargoStartSite").value;
	param.cargoTargetSite = document.getElementById("cargoTargetSite").value;
	param.vehiclePlateNo = document.getElementById("vehiclePlateNo").value;
	param.certificateNo = document.getElementById("certificateNo").value;
	...
	param.additionalAmount = document.getElementById("additionalAmount").value;
...
function validHolder() {
	var holderPartType = document.getElementById("holderPartType").value;
...
function validInsured() {
	var insuredPartType = document.getElementById("insuredPartType").value;
...
function validPolicy() {
	...
	var cargoStartSite = document.getElementById("cargoStartSite").value;
	var cargoTargetSite = document.getElementById("cargoTargetSite").value;
	...
	var cargoTransWay = document.getElementById("cargoTransWay").value;

	var goodsName = document.getElementsByName("goodsName").value;
	var category = document.getElementsByName("category").value;
	var countOrWeight = document.getElementsByName("countOrWeight").value;
	var insuredAmount = document.getElementsByName("insuredAmount").value;
	var premiumRate = document.getElementsByName("premiumRate").value;

	var allInsuredAmount = document.getElementById("allInsuredAmount").value;
	var additionalAmount = document.getElementById("additionalAmount").value;
	var allPremium = document.getElementById("allPremium").value;
	if(startDate == null || startDate == "") {
		$.messager.alert('提示','请填写起运时间!','info');
		return false;
	}
	if(cargoStartSite == null || cargoStartSite == "") {
		$.messager.alert('提示','请填写起运地!','info');
		return false;
	}
	if(cargoTargetSite == null || cargoTargetSite == "") {
		$.messager.alert('提示','请填写目的地!','info');
		return false;
	}
	if(vehiclePlateNo == null || vehiclePlateNo == "") {
		$.messager.alert('提示','请填写车牌号/车次!','info');
		return false;
	}
	if(certificateNo == null || certificateNo == "") {
		$.messager.alert('提示','请填写运输凭证号!','info');
		return false;
	}
	...
	if(additionalAmount == null || additionalAmount == "") {
		$.messager.alert('提示','请填写附加盗窃险金额!','info');
		return false;
	}

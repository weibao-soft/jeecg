...
<fieldset class="step" style="width:100%;padding-bottom: 20px;">
 ...
 <table cellpadding="0" cellspacing="1" class="formtable" width="1200">
	...
	<input id="premium" name="premium" type="hidden"/>
	 ...
	 <tr>
	 	<td style="width:5%">投保选择</td>
	 	<td style="width:90%">
		 	<table cellpadding="0" cellspacing="1" class="formtable" width="100%">
		 		<tr>
		 			<td style="width:15%"><span style="color: red;">*</span>保额</td>
		 			<td style="width:85%">
						<input name="sa" maxlength="10" type="text" class="inputxt"  style="width:80px;"  datatype="d"  ignore="checked" placeholder="3~200万" >
						<label class="Validform_label" style="display: none;">保额</label>
		 		</tr>
		 	</table>
	 	</td>
	 </tr>
	 		...
	 		<table cellpadding="0" cellspacing="1" class="formtable" width="100%">
		 		<tr>
		 			<td>
	 					<table cellpadding="0" cellspacing="1" class="formtable" width="100%">
		 					<tr>
		 						<td style="width:15%">投保人类型：</td>
		 						<td align="left">
		 							<input id="insur" class="subBtnmy" type="button" value="企业" onclick="" style="height:30px;width:100px !important;border-radius:5px"/>
									<input id="pay" class="subBtnmy" type="button" value="个人" onclick="" style="height:30px;width:100px !important;border-radius:5px" disabled/>		 						
		 						</td>
		 					</tr>
		 					<tr>
		 						<td style="width:15%">

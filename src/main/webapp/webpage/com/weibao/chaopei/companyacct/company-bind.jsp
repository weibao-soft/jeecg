...
.subBtnmy:hover {
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="companyAcctController.do?doBindAccount" >
		<input id="id" name="id" type="hidden" value="${companyAcct.id }"/>		
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="realName" name="realName" type="text" style="width: 200px;height: 15px" class="inputxt"  datatype="*" value="${companyAcct.realName }"/>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="certiNo" name="certiNo" type="text" style="width: 200px;height: 15px" class="inputxt" datatype="*" value="${companyAcct.certiNo }"/>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="bankInfo" name="bankInfo" type="text" style="width: 200px;height: 15px" datatype="*" class="inputxt" placeholder="请输入XX银行XX省XX市XX支行" value="${companyAcct.bankInfo }"/>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="bankNo" name="bankNo" type="text" style="width: 200px;height: 15px" datatype="d" class="inputxt" placeholder="请输入银行卡号" value="${companyAcct.bankNo }" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
	                    <input id="withdrawPasswd" class="inputxt" type="password" value="${user.password}" recheck="withdrawPasswd" datatype="*6-18" errormsg="两次输入的密码不一致！"/>

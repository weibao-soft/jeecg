...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="acctReceiveDetailList" checkbox="false" fitColumns="true" title="" actionUrl="companyAcctController.do?acctReceiveDetailDatagrid" 
   ...
   <t:dgCol title="保单号"  field="policyEntity"  width="100"></t:dgCol>
   <t:dgCol title="车牌号"  field="policyEntity.plateNo"  width="100"></t:dgCol>
   <t:dgCol title="签单日期"  field="policyEntity.payTime"  width="100"></t:dgCol>
   <t:dgCol title="出单机构"  field="policyEntity.reciAddress"  width="100"></t:dgCol>
   <t:dgCol title="出单员"  field="policyEntity.userId"  width="100"></t:dgCol>
   <t:dgCol title="分润金额"  field="amount"  width="100"></t:dgCol>
   <t:dgCol title="分润时间"  field="divideTime"  width="100"></t:dgCol>
   <%-- 

...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="acctReceiveDetailList" sortName="payTime" sortOrder="desc" checkbox="false" fitColumns="true" title="" actionUrl="companyAcctController.do?acctReceiveDetailDatagrid" 

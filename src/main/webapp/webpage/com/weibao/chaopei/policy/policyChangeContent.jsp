...
<script type="text/javascript">
    class PolicyChangeContent {
        ...
        static initData() {
            $.ajax({
                type: 'POST',
                url : 'policyChangeController.do?policyChangeContent',
                //dataType : 'json',
        ...
        static initEvents() {
            $('body').on('click', 'ul li img', function() {
                ...
                // parent.PolicyChangeManager.viewImage(src);
    ...
    PolicyChangeContent.initEvents();
    window.PolicyChangeContent = PolicyChangeContent;
    window.loadPage = PolicyChangeContent.load.bind(PolicyChangeContent);
</script>
</body>
</html>

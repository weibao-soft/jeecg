...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="policySubordList" checkbox="false" pagination="true" fitColumns="false" title="保单列表" pageSize="20"
   ...
   <t:dgCol title="出单机构"  field="departName" queryMode="group" sortable="false" width="120"></t:dgCol>
   <t:dgCol title="保单号"  field="policyNo" query="false" queryMode="single" sortable="false" width="200"></t:dgCol>
   <t:dgCol title="保费"  field="premium" queryMode="single" sortable="false" width="100"></t:dgCol>
   <t:dgCol title="保单状态"  field="status" query="true" queryMode="single" sortable="false" dictionary="qpolStatus" width="100"></t:dgCol>
   ...
   <t:dgCol title="保险产品"  field="prodName" width="150"></t:dgCol>
   <t:dgCol title="产品代码"  field="prodCode" hidden="true" queryMode="single" sortable="false" width="100"></t:dgCol>

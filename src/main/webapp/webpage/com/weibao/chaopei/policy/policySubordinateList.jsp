...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="policySubordList" checkbox="false" sortName="frameNo" pagination="true" fitColumns="false" title="保单列表" pageSize="20"
   ...
   <t:dgCol title="投保人"  frozenColumn="true" field="holderCompName" queryMode="single" width="220"></t:dgCol>
   ...
   <t:dgCol title="保单状态"  field="status" query="true" queryMode="single" sortable="false" dictionary="poliStatus" width="100"></t:dgCol>

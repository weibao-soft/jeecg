...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="acctUnreceiveDetailList" checkbox="false" title="未分润明细" actionUrl="personalAcctController.do?acctUnreceiveDetailDatagrid&personalAccountId=${personalAccountId }" 

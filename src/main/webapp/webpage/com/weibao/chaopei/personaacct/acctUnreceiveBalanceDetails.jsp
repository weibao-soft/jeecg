...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="acctUnreceiveDetailList" checkbox="false" fitColumns="true" title="" actionUrl="personalAcctController.do?acctUnreceiveDetailDatagrid" 
  	idField="id" fit="true" queryMode="group" collapsible="true" pageSize="100" sortName="payTime" sortOrder="desc" extendParams="view:scrollview">

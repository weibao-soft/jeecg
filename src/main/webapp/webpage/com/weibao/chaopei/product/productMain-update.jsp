...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="productMainController.do?doUpdate" callback="jeecgFormFileCallBack@Override">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="prodType" name="prodType" type="text" style="width: 150px"  class="inputxt" datatype="*" ignore="checked" value="${productEntityPage.prodType }" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="period" name="period" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" value="${productEntityPage.period }"/>
				<span class="Validform_checktip"></span>
